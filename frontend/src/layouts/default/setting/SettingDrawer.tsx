  ...
  setup(_, { attrs }) {
    ...
    return () => (
      <BasicDrawer
        ...
        v-slots={{
          // 标题放进抽屉自带的 header 行（与右上角关闭按钮同排，真正置顶）
          title: () => (
            <div class="setting-drawer-header">
              <span class="setting-drawer-title">⚙️ 项目设置</span>
            </div>
          ),
        }}
      >
        <div class="setting-drawer-content">
          <div class="setting-section">
            <div class="setting-section-title">
              <span class="setting-section-icon">🎨</span>
              <span class="setting-section-text">{t('layout.setting.navMode')}</span>
            </div>
            <div class="setting-section-desc">选择系统导航栏的布局模式</div>
            {renderSidebar()}
          </div>
        </div>
      </BasicDrawer>
